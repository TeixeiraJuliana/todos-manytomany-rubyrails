...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { description_list: @theme.description_list, title_list: @theme.title_list } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { description_list: @theme.description_list, title_list: @theme.title_list } }
